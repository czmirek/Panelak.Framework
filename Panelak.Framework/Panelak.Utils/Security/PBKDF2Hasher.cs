namespace Panelak.Utils
{
    ...
    /// Based on https://github.com/henkmollema/CryptoHelper/blob/master/src/CryptoHelper/Crypto.cs
    /// (which is based on the official .net core PasswordHasher<IUser>
    /// - changed from 10000 iterations to 100000 iterations
    /// </summary>
    public class PBKDF2Hasher : IPasswordHasher
    {
        /// <summary>
        /// Creates a new instance of PBKDF2Hasher.
        /// </summary>
        /// <param name="iterationCount">Iteration count</param>
        public PBKDF2Hasher(int iterationCount = 100000) 
        ...
        {
            byte[] bytes = HashPasswordInternal(password, KeyDerivationPrf.HMACSHA256, iterationCount, SaltSize, PBKDF2SubkeyLength);
