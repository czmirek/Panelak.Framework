namespace Panelak.Database.Test
{
    ...
    public class SqlServer_TestData
    {
        ...
        public void SimpleQueryTest()
        {
            ...
            IEnumerable<SqlServerTypesTestTable> data = connection.GetResult<SqlServerTypesTestTable>("SELECT * FROM SimpleTypesTestTable");
        ...
        {
            /*
            var connection = new SqlServerConnection("Server=127.0.0.1;Database=INGR_QUERYSERVQADATA;User Id=sa;Password=Heslo12345Heslo;", log);
            ...
            IEnumerable<SqlServerGeometryTable> data = connection.GetResult<SqlServerGeometryTable>(parametrizedQuery);*/
            //IEnumerable<SqlServerGeometryTable> data = connection.GetResult<SqlServerGeometryTable>("SELECT * FROM GeometryTestTable");
            //Assert.AreEqual(3, data.Count());
        }
    }
